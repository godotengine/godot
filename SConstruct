...
opts.Add(BoolVariable('builtin_hb', "Use the builtin harfbuzz library", True))
opts.Add(BoolVariable('builtin_icu', "Use the builtin icu library", True))

opts.Add(BoolVariable('icu_link_data', "Use static icu data", True))

opts.Add(BoolVariable('use_sil_graphite2', "Use the external SIL graphite2 library (LGPL licensed)", True))
