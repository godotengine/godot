...
static const char *s_ControllerMappings [] =
{
    ...
    "88880803000000000000504944564944,JAMANN,a:b2,b:b1,y:b0,x:b3,start:b11,guide:b12,back:b8,leftstick:b9,rightstick:b10,leftshoulder:b4,rightshoulder:b5,dpup:h0.1,dpleft:h0.8,dpdown:h0.4,dpright:h0.2,leftx:a0,lefty:a1,rightx:a3,righty:a4,lefttrigger:b6,righttrigger:b7,",
    //"c911f055000000000000504944564944,GAMEPAD,a:b0,b:b1,y:b3,x:b2,start:b9,back:b8,leftstick:b10,rightstick:b11,leftshoulder:b4,rightshoulder:b5,dpup:h0.1,dpleft:h0.8,dpdown:h0.4,dpright:h0.2,leftx:a0,lefty:a1,rightx:a2,righty:a3,lefttrigger:b6,righttrigger:b7,guide:b8",
...
#endif
#if X11_ENABLED
    // from github.com/gabomdq/SDL_GameControllerDB @ 0eb9b51ab1
    "0500000047532047616d657061640000,GameStop Gamepad,a:b0,b:b1,back:b8,dpdown:h0.4,dpleft:h0.8,dpright:h0.2,dpup:h0.1,guide:,leftshoulder:b4,leftstick:b10,lefttrigger:b6,leftx:a0,lefty:a1,rightshoulder:b5,rightstick:b11,righttrigger:b7,rightx:a2,righty:a3,start:b9,x:b2,y:b3,",
...
uint32_t InputDefault::joy_axis(uint32_t p_last_id, int p_device, int p_axis, float p_value) {
    ...
    if (p_value > joy.last_axis[p_axis]) {

        if (p_value < joy.last_axis[p_axis] + joy.filter ) {

            return p_last_id;
        }
    }
    else if (p_value > joy.last_axis[p_axis] - joy.filter) {
