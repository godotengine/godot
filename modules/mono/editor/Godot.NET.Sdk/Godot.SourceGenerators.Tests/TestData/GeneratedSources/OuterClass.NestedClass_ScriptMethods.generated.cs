...
#pragma warning disable CS0109 // Disable warning about redundant 'new' keyword
    ...
    protected internal new static partial class GodotInternal
    {
        public static void GetGodotMethodTrampolines(global::Godot.Bridge.MethodTrampolineCollector collector)
        {
            ...
            var aux_delegate_1__Get = trampoline_1__Get;
            collector.TryAdd(new(MethodName.@_Get, 1), new(aux_delegate_1__Get.Method.MethodHandle.GetFunctionPointer(), isStatic: false));
            collector.TryAdd(new(global::Godot.GodotObject.MethodName.@_Get, 1), new(aux_delegate_1__Get.Method.MethodHandle.GetFunctionPointer(), isStatic: false));
        }
    }
