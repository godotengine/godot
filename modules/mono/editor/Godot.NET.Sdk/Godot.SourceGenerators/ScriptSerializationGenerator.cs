...
namespace Godot.SourceGenerators
{
    ...
    public class ScriptSerializationGenerator : IIncrementalGenerator
    {
        ...
        {
            var areGodotSourceGeneratorsDisabled = context.AnalyzerConfigOptionsProvider.Select(static (provider, _) => provider.IsGodotSourceGeneratorDisabled("ScriptSerialization"));
