...
namespace Godot.SourceGenerators
{
    ...
    public class ScriptPropertyDefValGenerator : ISourceGenerator
    {
        ...
        )
        {
            ...
            bool isNode = symbol.InheritsNode();
