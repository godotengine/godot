...
public class PropertyTrampolineCollector
{
    ...
    /// </summary>
    public unsafe void TryAdd(StringName propertyName,
        PropertyGetterTrampoline getterTrampoline, PropertySetterTrampoline setterTrampoline)
    {
...
{
    public MethodTrampolineCollector MethodTrampolineCollector { get; } = methodTrampolineCollector;
    public PropertyTrampolineCollector PropertyTrampolineCollector { get; } = propertyTrampolineCollector;
    public RaiseSignalTrampolineCollector RaiseSignalTrampolineCollector { get; } = raiseSignalTrampolineCollector;
