...
{
    public sealed class ScriptSignalRegistry<T> : ScriptRegistry<T, SignalScriptMethod<GodotObject>, ScriptCache<T, SignalScriptMethod<GodotObject>>,
    ...
    public static class ScriptSignalRegistryExtensions
    {
        // This is an extension method because C# does not allow additional type constraints for an already existing T
