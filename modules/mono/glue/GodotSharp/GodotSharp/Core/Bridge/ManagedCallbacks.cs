...
namespace Godot.Bridge
{
    ...
    public unsafe struct ManagedCallbacks
    {
        ...
        public delegate* unmanaged<RaiseSignalTrampolineDelegate, IntPtr, godot_variant**, int, godot_variant_call_error*, godot_bool*, void> ScriptManagerBridge_RaiseEventSignalViaTrampoline;
