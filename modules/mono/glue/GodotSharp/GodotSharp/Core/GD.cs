...
namespace Godot
{
    public static partial class GD
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void godot_icall_GD_print(string[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void godot_icall_GD_printerr(string[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void godot_icall_GD_printraw(string[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void godot_icall_GD_prints(string[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void godot_icall_GD_printt(string[] what);
