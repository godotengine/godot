...
namespace Godot
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public real_t Angle() => Mathf.Atan2(y, x);
        ...
        public real_t AngleTo(Vector2 to) => Mathf.Atan2(Cross(to), Dot(to));
        ...
        /// <param name="to">The other vector to compare this vector to.</param>
        /// <returns>The angle between the two vectors, in radians.</returns>
        public real_t AngleToPoint(Vector2 to) => Mathf.Atan2(y - to.y, x - to.x);

        /// <summary>
        /// Returns the aspect ratio of this vector, the ratio of `x` to `y`.
        /// </summary>
        /// <returns>The `x` component divided by the `y` component.</returns>
        public real_t Aspect() => x / y;
        ...
        public Vector2 Ceil() => new Vector2(Mathf.Ceil(x), Mathf.Ceil(y));
        ...
        public real_t Cross(Vector2 b) => (x * b.y) - (y * b.x);
        ...
        public Vector2 DirectionTo(Vector2 b) => new Vector2(b.x - x, b.y - y).Normalized();
        ...
        public real_t DistanceSquaredTo(Vector2 to) => ((x - to.x) * (x - to.x)) + ((y - to.y) * (y - to.y));
        ...
        public real_t DistanceTo(Vector2 to) => Mathf.Sqrt(((x - to.x) * (x - to.x)) + ((y - to.y) * (y - to.y)));
        ...
        public real_t Length() => Mathf.Sqrt((x * x) + (y * y));
        ...
        public real_t LengthSquared() => (x * x) + (y * y);
        ...
        public Axis MaxAxis() => x < y ? Axis.Y : Axis.X;
        ...
        public Axis MinAxis() => x < y ? Axis.X : Axis.Y;
        ...
        public Vector2 Round() => new Vector2(Mathf.Round(x), Mathf.Round(y));

        [Obsolete(
            "Set is deprecated. Use the Vector2(" + nameof(real_t) + ", " + nameof(real_t) + ") constructor instead.",
            error: true)]
        ...
        public Vector2 Snapped(Vector2 step) => new Vector2(Mathf.Stepify(x, step.x), Mathf.Stepify(y, step.y));
        ...
        /// </summary>
        /// <returns>The perpendicular vector.</returns>
        public Vector2 Tangent() => new Vector2(y, -x);
        ...
        public static Vector2 NegOne => _negOne;
