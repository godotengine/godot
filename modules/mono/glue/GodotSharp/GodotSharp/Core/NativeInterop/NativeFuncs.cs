...
namespace Godot.NativeInterop
{
    ...
    internal static unsafe partial class NativeFuncs
    {
        ...
        [DllImport(GodotDllName)]
        public static extern void godotsharp_variant_new_transform(godot_variant* r_dest, Transform* p_trans);
        ...
        [DllImport(GodotDllName)]
        public static extern Quat godotsharp_variant_as_quat(godot_variant* p_self);
        ...
        [DllImport(GodotDllName)]
        public static extern Transform godotsharp_variant_as_transform(godot_variant* p_self);
