...
namespace Godot.NativeInterop
{
    ...
    internal struct godot_bool
    {
        ...
        public godot_bool(bool value) => _value = value;

        public static implicit operator bool(godot_bool godotBool) => godotBool._value;
    ...
    internal struct godot_variant : IDisposable
    {
        ...
        internal unsafe struct godot_variant_data
        {
            ...
            [FieldOffset(0)] public Transform* _transform;
            ...
            [FieldOffset(0)] public Quat _m_quat;
