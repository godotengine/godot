...
namespace Godot.NativeInterop
{
    internal static class VariantUtils
    {
        ...
        public static godot_variant CreateFromQuat(Quat from)
            => new() {_type = Variant.Type.Quat, _data = {_m_quat = from}};
        ...
        public static unsafe godot_variant CreateFromTransform(Transform from)
        {
            godot_variant ret;
            NativeFuncs.godotsharp_variant_new_transform(&ret, &from);
            return ret;
        }
        ...
        public static unsafe Quat ConvertToQuat(godot_variant* p_var)
            => (*p_var)._type == Variant.Type.Quat ? (*p_var)._data._m_quat : NativeFuncs.godotsharp_variant_as_quat(p_var);

        public static unsafe Transform ConvertToTransform(godot_variant* p_var)
            => (*p_var)._type == Variant.Type.Transform ? *(*p_var)._data._transform : NativeFuncs.godotsharp_variant_as_transform(p_var);
