...
public static class CustomUnsafe
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe godot_packed_projection_array* AsPointer(ref godot_packed_projection_array value)
        => value.GetUnsafeAddress();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe godot_packed_projection_array* ReadOnlyRefAsPointer(in godot_packed_projection_array value)
        => value.GetUnsafeAddress();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe ref godot_packed_projection_array AsRef(godot_packed_projection_array* source)
        => ref *source;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe ref godot_packed_projection_array AsRef(in godot_packed_projection_array source)
        => ref *ReadOnlyRefAsPointer(in source);
