...
namespace Godot
{
    ...
    public struct Basis : IEquatable<Basis>
    {
        ...
        public static Basis LookingAt(Vector3 target, Vector3? up = null, bool useModelFront = false)
        {
            ...
            {
                GD.PushWarning("Target and up vectors are colinear. This is not advised as it may cause unwanted rotation around local Z axis.");
                column0 = up.Value.GetAnyPerpendicular(); // Vectors are almost parallel.
            }
            column0.Normalize();
