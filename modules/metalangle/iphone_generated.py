def setup_iphone(p_env_thirdparty):
    thirdparty_obj = []
    ...
    env_thirdparty_4.add_source_files(
        ...
        [
            ...
            "#thirdparty/metalangle/src/libANGLE/renderer/gl/eagl/ContextEAGL.cpp",
            ...
            "#thirdparty/metalangle/src/libANGLE/renderer/gl/eagl/DeviceEAGL.cpp",
            ...
            "#thirdparty/metalangle/src/libANGLE/renderer/gl/eagl/RendererEAGL.cpp",
            ...
            "#thirdparty/metalangle/src/libANGLE/renderer/gl/eagl/PbufferSurfaceEAGL.cpp",
    ...
    env_thirdparty_8.Append(
        CPPFLAGS=[
            ...
            "-DJSON_USE_EXCEPTION=0",
            "-Wno-shorten-64-to-32",
            "-Ithirdparty/metalangle/third_party/jsoncpp/generated",
            "-Ithirdparty/metalangle/third_party/jsoncpp/source/src/lib_json",
        ],
    )
    env_thirdparty_8.add_source_files(
        thirdparty_obj,
        [
            "#thirdparty/metalangle/third_party/jsoncpp/source/src/lib_json/json_reader.cpp",
            "#thirdparty/metalangle/third_party/jsoncpp/source/src/lib_json/json_value.cpp",
            "#thirdparty/metalangle/third_party/jsoncpp/source/src/lib_json/json_writer.cpp",
        ],
    )
    ...
    env_thirdparty_9.add_source_files(
        thirdparty_obj,
        [
            "#thirdparty/metalangle/src/libANGLE/renderer/gl/eagl/DisplayEAGL.mm",
            "#thirdparty/metalangle/src/libANGLE/renderer/gl/eagl/IOSurfaceSurfaceEAGL.mm",
            "#thirdparty/metalangle/src/libANGLE/renderer/gl/eagl/WindowSurfaceEAGL.mm",
        ],
    )
