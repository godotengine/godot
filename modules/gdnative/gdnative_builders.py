...
def _build_gdnative_api_struct_header(api):
    ...
    for ext in api["extensions"]:
        name = ext["name"]
        gdnative_api_init_macro.append("\textern const godot_gdnative_ext_{0}_api_struct *_gdnative_wrapper_{0}_api_struct;".format(name))
    ...
    for ext in api["extensions"]:
        ...
        gdnative_api_init_macro.append("\t\t\t\t_gdnative_wrapper_{0}_api_struct = (godot_gdnative_ext_{0}_api_struct *)" " _gdnative_wrapper_api_struct->extensions[i];".format(name))
        gdnative_api_init_macro.append("\t\t\t\tbreak;")
    gdnative_api_init_macro.append("\t\t}")
    gdnative_api_init_macro.append("\t}")

    out = ["/* THIS FILE IS GENERATED DO NOT EDIT */", "#ifndef GODOT_GDNATIVE_API_STRUCT_H", "#define GODOT_GDNATIVE_API_STRUCT_H", "", "#include <gdnative/gdnative.h>", "#include <android/godot_android.h>", "#include <arvr/godot_arvr.h>", "#include <nativescript/godot_nativescript.h>", "#include <pluginscript/godot_pluginscript.h>", "", "#define GDNATIVE_API_INIT(options) do {  \\\n" + "  \\\n".join(gdnative_api_init_macro) + "  \\\n } while (0)", "", "#ifdef __cplusplus", 'extern "C" {', "#endif", "", "enum GDNATIVE_API_TYPES {", "\tGDNATIVE_" + api["core"]["type"] + ","]
    ...
    def generate_extension_struct(name, ext, include_version=True):
        ...
        ret_val += ["typedef struct godot_gdnative_ext_" + name + ("" if not include_version else ("_{0}_{1}".format(ext["version"]["major"], ext["version"]["minor"]))) + "_api_struct {", "\tunsigned int type;", "\tgodot_gdnative_api_version version;", "\tconst godot_gdnative_api_struct *next;"]
    ...
    def generate_core_extension_struct(core):
        ...
        ret_val += ["typedef struct godot_gdnative_core_" + ("{0}_{1}".format(core["version"]["major"], core["version"]["minor"])) + "_api_struct {", "\tunsigned int type;", "\tgodot_gdnative_api_version version;", "\tconst godot_gdnative_api_struct *next;"]
    ...
    out += ["typedef struct godot_gdnative_core_api_struct {", "\tunsigned int type;", "\tgodot_gdnative_api_version version;", "\tconst godot_gdnative_api_struct *next;", "\tunsigned int num_extensions;", "\tconst godot_gdnative_api_struct **extensions;"]

    for funcdef in api["core"]["api"]:
        args = ", ".join(["%s%s" % (_spaced(t), n) for t, n in funcdef["arguments"]])
        out.append("\t%s(*%s)(%s);" % (_spaced(funcdef["return_type"]), funcdef["name"], args))

    out += ["} godot_gdnative_core_api_struct;", "", "#ifdef __cplusplus", "}", "#endif", "", "#endif // GODOT_GDNATIVE_API_STRUCT_H", ""]
    return "\n".join(out)
...
def _build_gdnative_api_struct_source(api):
    ...
    def get_core_struct_definition(core):
        ...
        ret_val += ["extern const godot_gdnative_core_" + ("{0}_{1}_api_struct api_{0}_{1}".format(core["version"]["major"], core["version"]["minor"])) + " = {", "\tGDNATIVE_" + core["type"] + ",", "\t{" + str(core["version"]["major"]) + ", " + str(core["version"]["minor"]) + "},", "\t" + ("NULL" if not core["next"] else ("(const godot_gdnative_api_struct *)& api_{0}_{1}".format(core["version"]["major"], core["version"]["minor"]))) + ","]
    ...
    out += ["extern const godot_gdnative_core_api_struct api_struct = {", "\tGDNATIVE_" + api["core"]["type"] + ",", "\t{" + str(api["core"]["version"]["major"]) + ", " + str(api["core"]["version"]["minor"]) + "},", "\tNULL,", "\t" + str(len(api["extensions"])) + ",", "\tgdnative_extensions_pointers,"]
...
def _build_gdnative_wrapper_code(api):
    out = ["/* THIS FILE IS GENERATED DO NOT EDIT */", "", "#include <gdnative/gdnative.h>", "#include <nativescript/godot_nativescript.h>", "#include <pluginscript/godot_pluginscript.h>", "#include <arvr/godot_arvr.h>", "", "#include <gdnative_api_struct.gen.h>", "", "#ifdef __cplusplus", 'extern "C" {', "#endif", "", "godot_gdnative_core_api_struct *_gdnative_wrapper_api_struct = 0;"]
