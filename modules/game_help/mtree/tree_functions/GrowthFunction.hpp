...
namespace Mtree
{
	...
	private:
		...
		void apply_gravity_rec(TreeNode& node, Eigen::Matrix3f curent_rotation);
		void update_absolute_position_rec(TreeNode& node, const Eigen::Vector3f& node_position);
	...
	public:
		...
		Eigen::Vector3f absolute_position;
		float vigor_ratio = 1;
		float vigor = 0;
		int age = 0;
