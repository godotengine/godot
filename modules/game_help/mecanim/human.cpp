...
namespace human
{
    ...
    void Skeleton2HumanPose(Human const *apHuman, skeleton::SkeletonPose const *apSkeletonPose, HumanPose *apHumanPose, int32_t i)
    {
        if (apHuman->m_HumanBoneIndex[i] != -1)
        {
            const math::float3 xyz = skeleton::SkeletonGetDoF(apHuman->m_Skeleton.Get(), apSkeletonPose, apHuman->m_HumanBoneIndex[i]);
    ...
    math::float3 HumanGetGoalPosition(Human const *apHuman, skeleton::SkeletonPose const *apSkeletonPoseLocal, Goal goalIndex)
    {
        ...
        math::trsX goalX = skeleton::SkeletonGetGlobalX(apHuman->m_Skeleton.Get(), apSkeletonPoseLocal, index);
    ...
    {
        int32_t index = apHuman->m_HumanBoneIndex[s_HumanGoalInfo[goalIndex].m_Index];
        return AddAxis(apHuman, index, skeleton::SkeletonGetGlobalRotation(apHuman->m_Skeleton.Get(), apSkeletonPoseLocal, index));
    }
    ...
    void HumanFixEndPointsSkeletonPose(Human const *apHuman, skeleton::SkeletonPose const*apSkeletonPoseRef, HumanPose *apHumanPose, skeleton::SkeletonPose *apSkeletonPoseGbl, skeleton::SkeletonPose *apSkeletonPoseLcl, skeleton::SkeletonPose *apSkeletonPoseWs, int32_t cIndex)
    {
        ...
        skeleton::SkeletonPoseComputeLocalQ(apHuman->m_Skeleton.Get(), apSkeletonPoseGbl, apSkeletonPoseLcl, apHuman->m_HumanBoneIndex[cIndex], apHuman->m_HumanBoneIndex[cIndex]);
    }
    ...
    void Human2LimbAlign(Human const *apHuman, skeleton::SkeletonPose const*apSkeletonPoseRef, skeleton::SkeletonPose *apSkeletonPoseGbl, skeleton::SkeletonPose *apSkeletonPoseLcl, int32_t eIndex, int32_t pIndex)
    {
        ...
        skeleton::SkeletonPoseComputeLocal(apHuman->m_Skeleton.Get(), apSkeletonPoseGbl, apSkeletonPoseLcl, apHuman->m_HumanBoneIndex[pIndex], apHuman->m_HumanBoneIndex[pIndex]);
        skeleton::SkeletonPoseComputeGlobal(apHuman->m_Skeleton.Get(), apSkeletonPoseLcl, apSkeletonPoseGbl, apHuman->m_HumanBoneIndex[eIndex], apHuman->m_HumanBoneIndex[pIndex]);
    }
    ...
    {
        // 获取 Human 的骨架结构
        skeleton::Skeleton const *skeleton = apHuman->m_Skeleton.Get();

        // 计算全局骨架姿态，基于 Human 中的局部姿态，存储在 apSkeletonPoseGbl
        skeleton::SkeletonPoseComputeGlobal(skeleton, apHuman->m_SkeletonPose.Get(), apSkeletonPoseGbl);
        ...
        bool adjustMissingBones)              // 是否调整缺失的骨骼
    {
        ...
        {
            RetargetToTDoF(apHuman, apHumanPoseOut, apHuman->m_SkeletonPose.Get(), apSkeletonPose, apSkeletonPoseWs);
        }
