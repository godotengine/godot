#ifndef GAME_GUI_HBOX_H
#define GAME_GUI_HBOX_H
#include "game_gui_compoent.h"

class GUIHBox : public GUIComponent
{
    GDCLASS(GUIHBox, GUIComponent)
...
VARIANT_ENUM_CAST(GUIHBox::HorizontalContentAlignment)
