...
Variant *variant_new_nil() { return memnew(Variant()); }

EMSCRIPTEN_KEEPALIVE
Variant *variant_new_bool(bool v) { return memnew(Variant(v)); }

EMSCRIPTEN_KEEPALIVE
Variant *variant_new_int64(int64_t v) { return memnew(Variant(v)); }

EMSCRIPTEN_KEEPALIVE
Variant *variant_new_double(double v) { return memnew(Variant(v)); }
...
EMSCRIPTEN_KEEPALIVE
Variant *variant_new_dictionary() { return memnew(Variant(Dictionary())); }

EMSCRIPTEN_KEEPALIVE
Variant *variant_new_array() { return memnew(Variant(Array())); }
