...
namespace Godot
{
	public partial class Node
	{
		...
		public T GetNode<T>(NodePath path) where T : class
		{
			...
			// Create a new instance of T using the node's Id
			return (T)Activator.CreateInstance(typeof(T), new object[] { node.Id });
		}
		...
		{
			Node child = GetChild(idx, includeInternal);
			if (child == null) return null;
			return (T)Activator.CreateInstance(typeof(T), new object[] { child.Id });
		}
		...
		{
			int count = (int)GetChildCount(includeInternal);
		...
		public T GetOwner<T>() where T : class
		{
			...
			return (T)Activator.CreateInstance(typeof(T), new object[] { owner.Id });
		}
		...
		public T GetParent<T>() where T : class
		{
			...
			return (T)Activator.CreateInstance(typeof(T), new object[] { parent.Id });
		}
