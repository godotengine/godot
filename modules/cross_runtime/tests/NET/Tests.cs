...
public static class Tests
{
	...
	private const int OFF_ARRAY = 720;
	...
	private static void WriteAllData()
	{
		...
		// Dictionary – use Helpers.WriteDictionary
		...
		// Dictionary
		Helpers.WriteDictionary(OFF_DICTIONARY, dict);   // replaces Helpers.WriteDictionary

		// Array – use Helpers.WriteArray
