...
def __make_doc_data_class_path_header(doc_class_to_path: [(str, str)], output: str):
    ...
    with open(output, "w", encoding="utf-8") as f:
        f.write("static const int _doc_data_class_path_count = " + str(num_doc_classes) + ";\n")
        ...
        for doc_class, doc_path in doc_class_to_path:
            f.write('\t{"' + doc_class + '", "' + utils.forward_slashes(doc_path) + '"},\n')
...
def __make_doc_generated_files(
    module_db_file: str, project_root: str, output_data_class_path: str, output_doc_data_compressed: str
):
    ...
    for doc_path in doc_paths:
        ...
        doc_xmls = [os.path.relpath(doc_xml, project_root) for doc_xml in glob.glob(glob_path)]

        docs += doc_xmls
        doc_class_to_path += [(os.path.splitext(os.path.basename(doc_xml))[0], doc_path) for doc_xml in doc_xmls]

    __make_doc_data_class_path_header(doc_class_to_path, output_data_class_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("module_db", type=str, help="The module database json file")
    parser.add_argument("project_root", type=str, help="The project root directory")
    parser.add_argument("output_data_class_path", type=str, help="The output generated doc_data file.")
    parser.add_argument("output_doc_data_compressed", type=str, help="The output generated doc_data file.")
