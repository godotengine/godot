...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate regester_exporters.")

    parser.add_argument("platform", nargs="+", type=str, help="The platforms that have exporters.")
    parser.add_argument("output", type=str, help="The output generated file.")
