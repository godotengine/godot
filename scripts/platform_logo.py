...
def __make_platform_logo(input: str, output: str, platform: str):
    filedata: str = ""
    filename = os.path.basename(input).replace('.', '_')
    with open(input, "rb") as pngf:
        filedata = " /* AUTOGENERATED FILE, DO NOT EDIT */ \n"
        filedata += " static const char _" + platform + "_" + filename + "[]={"
...
if __name__ == "__main__":
    ...
    parser.add_argument("output", type=str, help="The output generated header file.")
    parser.add_argument("platform", type=str, help="The platform this logo is for.")
