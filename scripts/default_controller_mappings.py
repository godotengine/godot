...
def __make_default_controller_mappings(inputs: [str], output: str):
    g = open(output, "w")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate input mappings.')
    parser.add_argument('inputs', nargs='+', type=str)
    parser.add_argument('output')

    args = parser.parse_args()
    __make_default_controller_mappings(args.inputs, args.output)
