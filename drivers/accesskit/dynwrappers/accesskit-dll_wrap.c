...
// generated by generate-wrapper.py 0.6 on 2025-12-14 01:01:33
// flags: generate-wrapper.py --include ./accesskit.h --sys-include accesskit.h --soname libaccesskit.dll --init-name libaccesskit --output-header accesskit-dll_wrap.h --output-implementation accesskit-dll_wrap.c
//
...
#define accesskit_windows_adapter_debug accesskit_windows_adapter_debug_dylibloader_orig_libaccesskit
...
#undef accesskit_windows_adapter_debug
...
char *(*accesskit_windows_adapter_debug_dylibloader_wrapper_libaccesskit)(const struct accesskit_windows_adapter *);
...
// accesskit_windows_adapter_debug
  *(void **) (&accesskit_windows_adapter_debug_dylibloader_wrapper_libaccesskit) = dlsym(handle, "accesskit_windows_adapter_debug");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
