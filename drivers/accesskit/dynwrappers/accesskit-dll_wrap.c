...
void *dlsym(void *p_handle, const char *p_name) {
  ...
  void *f = GetProcAddress(hmodule, p_name);
  if (!f) {
...
char *(*accesskit_tree_get_app_name_dylibloader_wrapper_libaccesskit)(const struct accesskit_tree *);
void (*accesskit_tree_set_app_name_dylibloader_wrapper_libaccesskit)(struct accesskit_tree *, const char *);
void (*accesskit_tree_clear_app_name_dylibloader_wrapper_libaccesskit)(struct accesskit_tree *);
...
// accesskit_tree_get_app_name
  *(void **) (&accesskit_tree_get_app_name_dylibloader_wrapper_libaccesskit) = dlsym(handle, "accesskit_tree_get_app_name");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// accesskit_tree_set_app_name
  *(void **) (&accesskit_tree_set_app_name_dylibloader_wrapper_libaccesskit) = dlsym(handle, "accesskit_tree_set_app_name");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// accesskit_tree_clear_app_name
  *(void **) (&accesskit_tree_clear_app_name_dylibloader_wrapper_libaccesskit) = dlsym(handle, "accesskit_tree_clear_app_name");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
