...
// generated by generate-wrapper.py 0.7 on 2026-03-17 19:01:49
// flags: generate-wrapper.py --include ./thirdparty/linuxbsd_headers/pulse/pulseaudio.h --sys-include thirdparty/linuxbsd_headers/pulse/pulseaudio.h --include-dir ./thirdparty/linuxbsd_headers/ --soname libpulse.so.0 --soname __OpenBSD__,libpulse.so --omit-prefix _pa_ --init-name pulse --output-header ./drivers/pulseaudio/pulse-so_wrap.h --output-implementation ./drivers/pulseaudio/pulse-so_wrap.c
//
#include <stdint.h>
...
#ifdef __OpenBSD__
#define SONAME "libpulse.so"
#else
#define SONAME "libpulse.so.0"
#endif
