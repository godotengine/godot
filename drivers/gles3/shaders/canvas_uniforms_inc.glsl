...
#define INSTANCE_FLAGS_SPECIAL_MODE_MASK uint(1 << 6 | 1 << 7 | 1 << 8)
#define INSTANCE_FLAGS_USE_MSDF uint(1 << 6)
#define INSTANCE_FLAGS_USE_LCD uint(1 << 7)
#define INSTANCE_FLAGS_USE_SLUG uint(1 << 8)
#define INSTANCE_FLAGS_USE_SLUG_COLOR uint(1 << 7 | 1 << 8)

#define INSTANCE_FLAGS_NINEPATCH_DRAW_CENTER uint(1 << 9)
#define INSTANCE_FLAGS_NINEPATCH_H_MODE_SHIFT 10
#define INSTANCE_FLAGS_NINEPATCH_V_MODE_SHIFT 12

#define INSTANCE_FLAGS_SHADOW_MASKED_SHIFT 14u // 16 bits.
