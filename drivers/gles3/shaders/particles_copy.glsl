...
void main() {
	...
	instance_color_custom_data.x = godot_packHalf2x16(color.xy);
	instance_color_custom_data.y = godot_packHalf2x16(color.zw);
	instance_color_custom_data.z = godot_packHalf2x16(custom.xy);
	instance_color_custom_data.w = godot_packHalf2x16(custom.zw);
