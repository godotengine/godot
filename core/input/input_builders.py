        ...
        for src_path in map(str, source):
            if src_path.endswith(".txt"):
                ...
                for line in mapping_file_lines:
                    ...
                    if len(line) == 0:
                        continue
                    # We only need Android mappings from the database, since other platforms (except Web) already use SDL.
                    if line.startswith("#ifdef SDL_PLATFORM_ANDROID"):
