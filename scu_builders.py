...
def generate_scu_files(max_includes_per_scu):
    ...
    # No improvement to compile times by doing all core folders as one, so commented out for now.
    # process_folder(["core", "config", "debugger", "error", "io", "math", "os", "string", "templates", "variant"], ["variant_utility"],)
