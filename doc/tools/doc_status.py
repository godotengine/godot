...
class ClassStatus:
    ...
    def make_output(self) -> Dict[str, str]:
        ...
        for k in ["methods", "constants", "enums", "members", "theme_items", "signals", "constructors", "operators"]:
    ...
    def generate_for_class(c: ET.Element):
        ...
        for tag in list(c):
            ...
            elif tag.tag in ["constants", "enums", "members", "theme_items"]:
                for sub_tag in list(tag):
...
if flags["i"]:
    for r in ["methods", "constants", "enums", "members", "signals", "theme_items"]:
