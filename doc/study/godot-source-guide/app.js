...
const conceptAliasOverrides = {
  "autoload": "projectsettings",
  "main_scene": "projectsettings",
  "project.godot": "projectsettings",
  "viewport": "viewportwindowworld",
  "subviewport": "viewportwindowworld",
  "world2d": "viewportwindowworld",
  "world3d": "viewportwindowworld",
  ".import": "resourceimportpipeline",
  "resourceuid": "resourceimportpipeline",
  "resourceimporter": "resourceimportpipeline",
  "editorfilesystem": "resourceimportpipeline",
  "stringname": "stringnamenodepath",
  "nodepath": "stringnamenodepath",
  "sname": "stringnamenodepath",
  "err_fail": "errorandmemorymacros",
  "err_fail_cond": "errorandmemorymacros",
  "err_fail_null": "errorandmemorymacros",
  "memnew": "errorandmemorymacros",
  "memdelete": "errorandmemorymacros",
  "owner": "owner",
  ...
  "bind_method": "methodbind",
  "ptrcall": "methodbind",
  "call_deferred": "messagequeue",
  "connect_deferred": "messagequeue",
  "queue_delete": "scenetree",
  "instance_create": "renderingserver",
  "rendererrd": "rendererrd",
  "renderingdevice": "renderingdevice",
  "swap_buffers": "displayserver",
  "texture_2d_create": "renderingserver",
  "meshinstance3d": "mesh",
  "mesh_create": "mesh",
  "sync": "renderingserver",
  "control": "controlgui",
  "textserver": "controlgui",
  "gui_input": "controlgui",
  "accept_event": "controlgui",
  "notification_draw": "canvasitem",
  "create_tween": "animationtween",
  "editordebuggernode": "debugperformance",
  "displayserverwindows": "platformdrivers",
  "displayserverx11": "platformdrivers",
  "displayserverwayland": "platformdrivers",
  "displayservermacos": "platformdrivers",
  "displayserverandroid": "platformdrivers",
  "displayserverweb": "platformdrivers",
  "audiodriver": "platformdrivers",
  "audiodrivermanager": "platformdrivers",
  "inputevent": "inputsystem",
  "modules": "moduleatlas",
  "scsub": "moduleatlas",
  "gdregister_class": "classdb",
  "gdscript": "scriptextension",
  "physicsserver3dmanager": "physicsserver",
  "jolt physics": "physicsserver",
  ...
  "set_deferred": "messagequeue",
  "resourcecache": "resourceloader",
  "rid_owner": "rid",
  "initialize_modules": "moduleatlas",
  "gdextensionmanager": "scriptextension"
};
...
function buildConceptAliasEntries() {
  ...
  return concepts.flatMap((concept) => [concept.title || concept.id, ...(concept.aliases || [])].map((alias) => ({
    ...
    const overrideConceptId = conceptAliasOverrides[entry.lookup];
    if (overrideConceptId && overrideConceptId !== entry.conceptId) return false;
