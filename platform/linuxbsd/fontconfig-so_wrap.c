...
// generated by generate-wrapper.py 0.7 on 2026-03-17 16:04:34
// flags: generate-wrapper.py --include ./thirdparty/linuxbsd_headers/fontconfig/fontconfig.h --sys-include thirdparty/linuxbsd_headers/fontconfig/fontconfig.h --include-dir ./thirdparty/linuxbsd_headers/ --soname libfontconfig.so.1 --soname __OpenBSD__,libfontconfig.so --init-name fontconfig --omit-prefix FcCharSetFirst --omit-prefix FcCharSetNext --output-header ./platform/linuxbsd/fontconfig-so_wrap.h --output-implementation ./platform/linuxbsd/fontconfig-so_wrap.c
//
#include <stdint.h>
...
#ifdef __OpenBSD__
#define SONAME "libfontconfig.so"
#else
#define SONAME "libfontconfig.so.1"
#endif
