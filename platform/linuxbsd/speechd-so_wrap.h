...
// generated by generate-wrapper.py 0.7 on 2026-03-17 16:04:28
// flags: generate-wrapper.py --include ./thirdparty/linuxbsd_headers/speechd/libspeechd.h --sys-include thirdparty/linuxbsd_headers/speechd/libspeechd.h --include-dir ./thirdparty/linuxbsd_headers/ --soname libspeechd.so.2 --soname __OpenBSD__,libspeechd.so --init-name speechd --omit-prefix spd_get_client_list --output-header ./platform/linuxbsd/speechd-so_wrap.h --output-implementation ./platform/linuxbsd/speechd-so_wrap.c
//
#include <stdint.h>
