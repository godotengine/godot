...
const struct wl_interface *(*wl_proxy_get_interface_dylibloader_wrapper_wayland_client)(struct wl_proxy *);
struct wl_display *(*wl_proxy_get_display_dylibloader_wrapper_wayland_client)(struct wl_proxy *);
void (*wl_proxy_set_queue_dylibloader_wrapper_wayland_client)(struct wl_proxy *, struct wl_event_queue *);
struct wl_event_queue *(*wl_proxy_get_queue_dylibloader_wrapper_wayland_client)(const struct wl_proxy *);
const char *(*wl_event_queue_get_name_dylibloader_wrapper_wayland_client)(const struct wl_event_queue *);
...
int (*wl_display_dispatch_timeout_dylibloader_wrapper_wayland_client)(struct wl_display *, const struct timespec *);
int (*wl_display_dispatch_queue_timeout_dylibloader_wrapper_wayland_client)(struct wl_display *, struct wl_event_queue *, const struct timespec *);
...
struct wl_event_queue *(*wl_display_create_queue_with_name_dylibloader_wrapper_wayland_client)(struct wl_display *, const char *);
...
void (*wl_display_set_max_buffer_size_dylibloader_wrapper_wayland_client)(struct wl_display *, size_t);
...
// wl_proxy_get_interface
  *(void **) (&wl_proxy_get_interface_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_proxy_get_interface");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// wl_proxy_get_display
  *(void **) (&wl_proxy_get_display_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_proxy_get_display");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// wl_proxy_get_queue
  *(void **) (&wl_proxy_get_queue_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_proxy_get_queue");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// wl_event_queue_get_name
  *(void **) (&wl_event_queue_get_name_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_event_queue_get_name");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// wl_display_dispatch_timeout
  *(void **) (&wl_display_dispatch_timeout_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_display_dispatch_timeout");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// wl_display_dispatch_queue_timeout
  *(void **) (&wl_display_dispatch_queue_timeout_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_display_dispatch_queue_timeout");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// wl_display_create_queue_with_name
  *(void **) (&wl_display_create_queue_with_name_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_display_create_queue_with_name");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
...
// wl_display_set_max_buffer_size
  *(void **) (&wl_display_set_max_buffer_size_dylibloader_wrapper_wayland_client) = dlsym(handle, "wl_display_set_max_buffer_size");
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
      fprintf(stderr, "%s\n", error);
