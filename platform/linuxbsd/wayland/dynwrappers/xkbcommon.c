...
char* (*xkb_context_include_path_get_dylibloader_wrapper_xkbcommon)( struct xkb_context*, unsigned int);
...
char* (*xkb_keymap_key_get_name_dylibloader_wrapper_xkbcommon)( struct xkb_keymap*, xkb_keycode_t);
...
char* (*xkb_keymap_mod_get_name_dylibloader_wrapper_xkbcommon)( struct xkb_keymap*, xkb_mod_index_t);
...
char* (*xkb_keymap_layout_get_name_dylibloader_wrapper_xkbcommon)( struct xkb_keymap*, xkb_layout_index_t);
...
char* (*xkb_keymap_led_get_name_dylibloader_wrapper_xkbcommon)( struct xkb_keymap*, xkb_led_index_t);
