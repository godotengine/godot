...
void* (*wl_proxy_get_listener_dylibloader_wrapper_wayland_client)( struct wl_proxy*);
...
char** (*wl_proxy_get_tag_dylibloader_wrapper_wayland_client)( struct wl_proxy*);
char* (*wl_proxy_get_class_dylibloader_wrapper_wayland_client)( struct wl_proxy*);
