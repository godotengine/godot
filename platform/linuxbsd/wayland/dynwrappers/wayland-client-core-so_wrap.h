...
// generated by generate-wrapper.py 0.7 on 2026-08-21 08:28:04
...
#define wl_proxy_get_interface wl_proxy_get_interface_dylibloader_orig_wayland_client
#define wl_proxy_get_display wl_proxy_get_display_dylibloader_orig_wayland_client
#define wl_proxy_set_queue wl_proxy_set_queue_dylibloader_orig_wayland_client
#define wl_proxy_get_queue wl_proxy_get_queue_dylibloader_orig_wayland_client
#define wl_event_queue_get_name wl_event_queue_get_name_dylibloader_orig_wayland_client
...
#define wl_display_dispatch_timeout wl_display_dispatch_timeout_dylibloader_orig_wayland_client
#define wl_display_dispatch_queue_timeout wl_display_dispatch_queue_timeout_dylibloader_orig_wayland_client
...
#define wl_display_create_queue_with_name wl_display_create_queue_with_name_dylibloader_orig_wayland_client
...
#define wl_display_set_max_buffer_size wl_display_set_max_buffer_size_dylibloader_orig_wayland_client
...
#undef wl_proxy_get_interface
#undef wl_proxy_get_display
#undef wl_proxy_set_queue
#undef wl_proxy_get_queue
#undef wl_event_queue_get_name
...
#undef wl_display_dispatch_timeout
#undef wl_display_dispatch_queue_timeout
...
#undef wl_display_create_queue_with_name
...
#undef wl_display_set_max_buffer_size
#ifdef __cplusplus
extern "C" {
#endif
...
#define wl_proxy_get_interface wl_proxy_get_interface_dylibloader_wrapper_wayland_client
#define wl_proxy_get_display wl_proxy_get_display_dylibloader_wrapper_wayland_client
#define wl_proxy_set_queue wl_proxy_set_queue_dylibloader_wrapper_wayland_client
#define wl_proxy_get_queue wl_proxy_get_queue_dylibloader_wrapper_wayland_client
#define wl_event_queue_get_name wl_event_queue_get_name_dylibloader_wrapper_wayland_client
...
#define wl_display_dispatch_timeout wl_display_dispatch_timeout_dylibloader_wrapper_wayland_client
#define wl_display_dispatch_queue_timeout wl_display_dispatch_queue_timeout_dylibloader_wrapper_wayland_client
...
#define wl_display_create_queue_with_name wl_display_create_queue_with_name_dylibloader_wrapper_wayland_client
...
#define wl_display_set_max_buffer_size wl_display_set_max_buffer_size_dylibloader_wrapper_wayland_client
...
extern int (*wl_list_length_dylibloader_wrapper_wayland_client)(const struct wl_list *);
extern int (*wl_list_empty_dylibloader_wrapper_wayland_client)(const struct wl_list *);
...
extern const struct wl_interface *(*wl_proxy_get_interface_dylibloader_wrapper_wayland_client)(struct wl_proxy *);
extern struct wl_display *(*wl_proxy_get_display_dylibloader_wrapper_wayland_client)(struct wl_proxy *);
extern void (*wl_proxy_set_queue_dylibloader_wrapper_wayland_client)(struct wl_proxy *, struct wl_event_queue *);
extern struct wl_event_queue *(*wl_proxy_get_queue_dylibloader_wrapper_wayland_client)(const struct wl_proxy *);
extern const char *(*wl_event_queue_get_name_dylibloader_wrapper_wayland_client)(const struct wl_event_queue *);
...
extern int (*wl_display_dispatch_timeout_dylibloader_wrapper_wayland_client)(struct wl_display *, const struct timespec *);
extern int (*wl_display_dispatch_queue_timeout_dylibloader_wrapper_wayland_client)(struct wl_display *, struct wl_event_queue *, const struct timespec *);
...
extern struct wl_event_queue *(*wl_display_create_queue_with_name_dylibloader_wrapper_wayland_client)(struct wl_display *, const char *);
...
extern void (*wl_display_set_max_buffer_size_dylibloader_wrapper_wayland_client)(struct wl_display *, size_t);
