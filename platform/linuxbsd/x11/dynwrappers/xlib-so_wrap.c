...
// generated by generate-wrapper.py 0.7 on 2026-03-17 16:03:23
// flags: generate-wrapper.py --include ./thirdparty/linuxbsd_headers/X11/Xlib.h --include ./thirdparty/linuxbsd_headers/X11/Xutil.h --include ./thirdparty/linuxbsd_headers/X11/XKBlib.h --sys-include thirdparty/linuxbsd_headers/X11/Xlib.h --sys-include thirdparty/linuxbsd_headers/X11/Xutil.h --sys-include thirdparty/linuxbsd_headers/X11/XKBlib.h --include-dir ./thirdparty/linuxbsd_headers/ --soname libX11.so.6 --soname __OpenBSD__,libX11.so --soname __NetBSD__,libX11.so.7 --init-name xlib --omit-prefix XkbGetDeviceIndicatorState --omit-prefix XkbAddSymInterpret --output-header ./platform/linuxbsd/x11/dynwrappers/xlib-so_wrap.h --include-dir ./thirdparty/linuxbsd_headers/ --output-implementation ./platform/linuxbsd/x11/dynwrappers/xlib-so_wrap.c
//
#include <stdint.h>
...
#ifdef __OpenBSD__
#define SONAME "libX11.so"
#elif defined(__NetBSD__)
#define SONAME "libX11.so.7"
#else
#define SONAME "libX11.so.6"
#endif
