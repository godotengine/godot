...
// generated by generate-wrapper.py 0.7 on 2026-03-17 16:03:04
// flags: generate-wrapper.py --include ./thirdparty/linuxbsd_headers/X11/extensions/Xrender.h --sys-include thirdparty/linuxbsd_headers/X11/extensions/Xrender.h --include-dir ./thirdparty/linuxbsd_headers/ --soname libXrender.so.1 --soname __OpenBSD__,libXrender.so --soname __NetBSD__,libXrender.so.2 --init-name xrender --output-header ./platform/linuxbsd/x11/dynwrappers/xrender-so_wrap.h --output-implementation ./platform/linuxbsd/x11/dynwrappers/xrender-so_wrap.c --ignore-other
//
#include <stdint.h>
