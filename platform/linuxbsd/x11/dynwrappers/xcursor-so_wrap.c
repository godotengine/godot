...
// generated by generate-wrapper.py 0.7 on 2026-03-17 16:03:50
// flags: generate-wrapper.py --include ./thirdparty/linuxbsd_headers/X11/Xcursor/Xcursor.h --sys-include thirdparty/linuxbsd_headers/X11/Xcursor/Xcursor.h --include-dir ./thirdparty/linuxbsd_headers/ --soname libXcursor.so.1 --soname __OpenBSD__,libXcursor.so --init-name xcursor --output-header ./platform/linuxbsd/x11/dynwrappers/xcursor-so_wrap.h --output-implementation ./platform/linuxbsd/x11/dynwrappers/xcursor-so_wrap.c --ignore-other
//
#include <stdint.h>
...
#ifdef __OpenBSD__
#define SONAME "libXcursor.so"
#else
#define SONAME "libXcursor.so.1"
#endif
