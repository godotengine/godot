...
// generated by generate-wrapper.py 0.7 on 2026-03-17 16:03:18
// flags: generate-wrapper.py --include ./thirdparty/linuxbsd_headers/X11/extensions/Xrandr.h --sys-include thirdparty/linuxbsd_headers/X11/extensions/Xrandr.h --include-dir ./thirdparty/linuxbsd_headers/ --soname libXrandr.so.2 --soname __OpenBSD__,libXrandr.so --soname __NetBSD__,libXrandr.so.3 --init-name xrandr --output-header ./platform/linuxbsd/x11/dynwrappers/xrandr-so_wrap.h --output-implementation ./platform/linuxbsd/x11/dynwrappers/xrandr-so_wrap.c --ignore-other
//
#include <stdint.h>
