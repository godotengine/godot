...
def get_opts():
    ...
    return [("osxcross_sdk", "OSXCross SDK version", "darwin14"), EnumVariable("debug_symbols", "Add debugging symbols to release builds", "yes", ("yes", "no", "full")), BoolVariable("separate_debug_symbols", "Create a separate file containing debugging symbols", False)]
