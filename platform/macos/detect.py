...
def configure(env: "SConsEnvironment"):
    ...
    env.Append(ASFLAGS=["-arch", env["arch"], f"-mmacosx-version-min={min_version}"])
    env.Append(CCFLAGS=["-arch", env["arch"], f"-mmacosx-version-min={min_version}"])
    env.Append(LINKFLAGS=["-arch", env["arch"], f"-mmacosx-version-min={min_version}"])
