...
def get_opts():
    ...
    return [
        ...
        (
            ...
            "/Applications/Xcode.app/Contents/Developer/Platforms/${IPHONEPLATFORM}.platform/Developer/SDKs/${IPHONEPLATFORM}.sdk/",
        ),
    ...
    if env["arch"] == "x86" or env["arch"] == "x86_64":
        ...
        env.Append(
            CCFLAGS=(
                "-arch "
                + arch_flag
                + ' -fobjc-abi-version=2 -fobjc-legacy-dispatch -fmessage-length=0 -fpascal-strings -fblocks -fasm-blocks -isysroot $IPHONESDK -mios-simulator-version-min=9.0 -DCUSTOM_MATRIX_TRANSFORM_H=\\"build/iphone/matrix4_iphone.h\\" -DCUSTOM_VECTOR3_TRANSFORM_H=\\"build/iphone/vector3_iphone.h\\"'
            ).split()
        )
    elif env["arch"] == "arm":
        env.Append(
        ...
        env.Append(
            CCFLAGS="-fno-objc-arc -arch arm64 -fmessage-length=0 -fno-strict-aliasing -fdiagnostics-print-source-range-info -fdiagnostics-show-category=id -fdiagnostics-parseable-fixits -fpascal-strings -fblocks -fvisibility=hidden -MMD -MT dependencies -miphoneos-version-min=9.0 -isysroot $IPHONESDK".split()
        )
