...
DisplayServer::WindowID DisplayServerWindows::_create_window(WindowMode p_mode, uint32_t p_style, const Rect2i &p_rect) {
	...
	_get_window_style(window_id_counter == MAIN_WINDOW_ID, p_mode == WINDOW_MODE_FULLSCREEN, p_style & WINDOW_FLAG_BORDERLESS_BIT, !(p_style & WINDOW_FLAG_RESIZE_DISABLED_BIT), p_mode == WINDOW_MODE_MAXIMIZED, dwStyle, dwExStyle);
