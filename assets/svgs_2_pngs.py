...
theme_dir_base = '../scene/resources/default_theme/'
...
def export_icons():
    icons_dir_base = '../tools/editor/icons/'
...
special_icons = {
    ...
    'icon_color_pick': dict( theme_output_names= ['icon_color_pick'] ),
    'icon_play': dict( theme_output_names= ['icon_play'] ),
    'icon_stop': dict( theme_output_names= ['icon_stop'] ),
    'icon_zoom_less': dict( theme_output_names= ['icon_zoom_less'] ),
    'icon_zoom_reset': dict( theme_output_names= ['icon_zoom_reset'] )
}
