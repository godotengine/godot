...
def generate_bundle_apple_embedded(platform, framework_dir, framework_dir_sim, use_mkv, target, source, env):
    ...
    # env.extra_suffix contains ".simulator" when applicable
    rel_target_bin = lipo(bin_dir + "/" + rel_prefix, ".a")
    dbg_target_bin = lipo(bin_dir + "/" + dbg_prefix, ".a")
    rel_target_bin_sim = lipo(bin_dir + "/" + rel_prefix, env.extra_suffix + ".a")
    dbg_target_bin_sim = lipo(bin_dir + "/" + dbg_prefix, env.extra_suffix + ".a")
