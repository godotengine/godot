...
def __generate(in_path, out_path):
...
################################################################################
# Godot local modification for meson
################################################################################

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='heightmap cpp generator')
    ...
    __generate(args.input, args.output)
