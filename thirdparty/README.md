...
A file typically generated by cmake added to Godot is `miniupnpcstrings.h`.
Important: `connecthostport.c` was modified to timeout on the socket
select function as well as the connect function.
