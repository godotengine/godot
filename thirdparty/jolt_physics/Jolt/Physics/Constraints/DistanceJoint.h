...
class JPH_EXPORT DistanceJoint final : public TwoBodyConstraint {
public:
	JPH_OVERRIDE_NEW_DELETE

	/// Construct distance constraint
	DistanceJoint(Body &inBody1, Body &inBody2, const DistanceConstraintSettings &inSettings);
	...
	void SetDistance(float inMinDistance, float inMaxDistance) {
		JPH_ASSERT(inMinDistance <= inMaxDistance);
