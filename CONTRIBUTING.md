...
source and web-based translation platform. Please refer to the [documentation](https://docs.godotengine.org/en/stable/contributing/documentation/editor_and_docs_localization.html) for more information.
