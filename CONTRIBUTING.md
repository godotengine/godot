...
There is also a dedicated [Godot contributing documentation](https://contributing.godotengine.org/en/latest/index.html)
...
[Introduction to engine contributions](https://contributing.godotengine.org/en/latest/engine/introduction.html)
and [Engine contribution guidelines](https://contributing.godotengine.org/en/latest/engine/guidelines/index.html)
...
also have important information on the [PR workflow](https://contributing.godotengine.org/en/latest/organization/pull_requests/index.html)
(with a helpful [guide for Git usage](https://contributing.godotengine.org/en/latest/organization/pull_requests/creating_pull_requests.html))
and the [Pull request review process](https://contributing.godotengine.org/en/latest/organization/pull_requests/review_process.html)
with insights into the intended lifecycle of pull requests.
This should help you ensure that your pull request fulfills the requirements.
...
See our [PR workflow](https://contributing.godotengine.org/en/latest/organization/pull_requests/index.html)
...
[Documentation writing guidelines](https://contributing.godotengine.org/en/latest/documentation/guidelines/index.html).
