...
#ifdef LIGHTMAP_BICUBIC_FILTER
			vec3 lm_light_l0 = textureArray_bicubic(lightmap_textures[ofs], uvw + vec3(0.0, 0.0, 0.0), instances.data[draw_call.instance_index].lightmap_texture_size).rgb;
			vec3 lm_light_l1n1 = textureArray_bicubic(lightmap_textures[ofs], uvw + vec3(0.0, 0.0, 1.0), instances.data[draw_call.instance_index].lightmap_texture_size).rgb;
			vec3 lm_light_l1_0 = textureArray_bicubic(lightmap_textures[ofs], uvw + vec3(0.0, 0.0, 2.0), instances.data[draw_call.instance_index].lightmap_texture_size).rgb;
			vec3 lm_light_l1p1 = textureArray_bicubic(lightmap_textures[ofs], uvw + vec3(0.0, 0.0, 3.0), instances.data[draw_call.instance_index].lightmap_texture_size).rgb;
#else
