...
**[Maodot Engine](https://godotengine.org) is a feature-packed, cross-platform
...
Maodot is completely free and open source under the very permissive [MIT license](https://godotengine.org/license).
No strings attached, no royalties, nothing. The users' games are theirs, down
to the last line of engine code. Maodot's development is fully independent and
community-driven, empowering users to help shape their engine to match their
expectations. It is supported by the [Maodot Foundation](https://godot.foundation/)
not-for-profit.

Before being open sourced in [February 2014](https://github.com/godotengine/godot/commit/0b806ee0fc9097fa7bda7ac0109191c9c5e0a1ac),
Maodot had been developed by [Juan Linietsky](https://github.com/reduz) and
...
Official binaries for the Maodot editor and the export templates can be found
[on the Maodot website](https://godotengine.org/download).
...
[Maodot Contributors Chat](https://chat.godotengine.org).
