...
- First run and first visible result: [docs/getting-started/quick-start.md](docs/getting-started/quick-start.md)
- Artist workflow overview: [docs/user/quickstart.md](docs/user/quickstart.md)
...
- Build/test/CI command reference: [docs/reference/build-test-ci.md](docs/reference/build-test-ci.md)
