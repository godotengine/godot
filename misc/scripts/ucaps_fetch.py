...
"""
    ...
    source += make_cap_table("caps_table_no_ascii", lower_to_upper, starting_from=0x00FF)
    source += make_cap_table("reverse_caps_table_no_ascii", upper_to_lower, starting_from=0x0100)
